package nl.spaanderict.firebasetest;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        woorden = FirebaseDatabase.getInstance("https://fir-test-dd103-default-rtdb.europe-west1.firebasedatabase.app/").getReference("woorden").getRef();
